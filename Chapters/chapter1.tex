...
a) In a jupyter notebook, write python functions to convert induction, moment and magnetic field quantities in cgs units to SI units.   Use the conversion factors in Table~\ref{tab:units}.    Use your program to convert the following: 
