...
The radial ($H_r$) and tangential ($H_{\theta}$) components of $\H$ at P (Figure~\ref{fig:mH}) then would be:
...
$$\nabla = {\partial\over { dr}} +  {\partial\over {r\partial \theta}}.
$$
...
\begin{figure}[htb]
 \centering \includegraphics[width=8 cm]{EPSfiles/dipole.eps}
...
\begin{figure}[h!tb]
 \centering \includegraphics[width=8 cm]{EPSfiles/mH.eps}
\caption
{Field $\H$ produced at point P by a magnetic  moment $\m$. $\H_r$
and $\H_{tan}$ are the radial and tangential fields respectively.}
\label{fig:mH}
\end{figure}
