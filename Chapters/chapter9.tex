...
\begin{itemize}
\item  Look at  the chapter on the MagIC database and file formats in the \href{http://earthref.org/PmagPy/cookbook}{PmagPy cookbook}.  
\item Click on the QuickMagIC button `3. fill Earth-Ref data' and verify the relationship of the specimens to the samples.  Click on `Save and continue'.  
