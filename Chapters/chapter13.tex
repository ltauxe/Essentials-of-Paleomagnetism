...
a) Calculate the average bedding pole direction from the strike and dip measurements.  [Hint:  convert each strike and dip to its pole by: pole declination = strike -90; pole inclination = 90 - dip.
