...
SD grains of hematite ($\alpha$Fe$_2$O$_3$) are precipitating from solution at a temperature of 280K.  The coercivity  is $\mu_o H_c$= 1 T.  Use what you need from Table~\ref{tab:rockpars} from Chapter 6 and  find  the diameter of a spherical hematite particle with a relaxation time of 100 seconds. 
...
water.     [HINT:   use values listed in Table~\ref{tab:rockpars} from Chapter 6.]
